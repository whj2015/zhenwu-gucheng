...
export default function BattleResultPanel({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-md animate-in fade-in duration-300 p-3 lg:p-6 pb-20 lg:pb-0">
            ...
            <div className={cn(
                "relative w-full max-w-5xl mx-auto bg-[#0d0f12]/95 border rounded-2xl shadow-2xl flex flex-col max-h-[92vh] lg:max-h-[90vh]",
                ...
                {/* Header - 固定高度 */}
                <div className={cn(
                    "relative border-b px-3 py-2 lg:px-8 lg:py-4 flex items-center justify-between shrink-0",
                ...
                <div className="flex flex-col lg:flex-row flex-1 min-h-0 overflow-hidden">
                    ...
                    <div className="flex-1 flex flex-col lg:border-r border-white/5 min-w-0">
                        <div className="px-3 py-1.5 lg:px-6 lg:py-2.5 border-b border-white/5 flex items-center gap-2 shrink-0">
                        ...
                        <div className="flex-1 overflow-y-auto p-2 lg:p-4 space-y-0.5 custom-scrollbar max-h-[30vh] lg:max-h-[calc(90vh-180px)]">
                    ...
                    <div className="w-full lg:w-80 xl:w-96 flex flex-col overflow-y-auto custom-scrollbar shrink-0 border-t lg:border-t-0 lg:border-l border-white/5 max-h-[45vh] lg:max-h-none">
                        {/* Enemy Status */}
                        <div className="p-2.5 lg:p-4 border-b border-white/5 shrink-0">
                        ...
                        {/* Rewards */}
                        {battleData.victory && (
                            <div className="p-2.5 lg:p-4 shrink-0">
                                <div className="text-[10px] font-bold uppercase tracking-widest text-slate-500 mb-2 flex items-center gap-1.5">
