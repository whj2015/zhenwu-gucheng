...
return <MapExploreView onBattleComplete={handleBattleComplete} />;
            ...
            return (
                <div className="max-w-4xl mx-auto flex flex-col items-center justify-center gap-4 sm:gap-5 lg:gap-5 animate-in fade-in duration-500 px-4 sm:px-6 lg:px-8 pb-20 lg:pb-0">
