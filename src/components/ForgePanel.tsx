    ...
    return (
        <div className="max-w-4xl mx-auto space-y-5 animate-in fade-in duration-500">
             <div className="flex justify-between items-end border-b border-white/10 pb-4">
                 <div>
                    <h2 className="text-2xl font-serif tracking-wide text-orange-100">兵甲坊 <span className="text-orange-500/80 text-sm font-sans ml-2">LV.{lvl}</span></h2>
             ...
             {/* Crafting Queue Area */}
             <div className="h-24 bg-black/40 border border-white/5 rounded-xl px-6 flex items-center justify-center gap-6 shadow-xl relative overflow-hidden">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                 {Object.entries(CRAFTING_TEMPLATES).map(([id, t]) => {
                     ...
                     return (
                         <div key={id} className="bg-white/5 border border-white/10 rounded-xl p-5 flex flex-col relative overflow-hidden group">
                              <div className={cn(
                              ...
                              <div className="flex justify-between items-start relative z-10">
                                  <div className="w-12 h-12 bg-black/40 border border-white/10 rounded-lg flex items-center justify-center mb-3">
                                      {TYPE_ICONS[t.type]}
                                  </div>
