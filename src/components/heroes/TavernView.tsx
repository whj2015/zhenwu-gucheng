...
export default function TavernView() {
    ...
    return (
        <div className="flex flex-col h-full">
            <div className="flex items-center justify-between mb-4 lg:mb-6 pb-4 border-b border-white/10">
                <div>
                    <h3 className="text-base lg:text-lg font-serif text-slate-200">过客留名</h3>
            ...
            {tavernPool.length === 0 ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 pb-8 overflow-y-auto custom-scrollbar flex-1">
                    {tavernPool.map((id) => {
                        ...
                        return (
                            <div key={id} className="bg-[#121418] border border-white/5 rounded-xl p-4 lg:p-6 flex flex-col relative overflow-hidden group shadow-lg">
                                ...
                                <div className="flex items-center space-x-4 mb-4 relative z-10">
                                    <div className="w-10 h-10 lg:w-12 lg:h-12 rounded bg-black/40 flex items-center justify-center font-serif text-2xl font-bold border border-white/10 text-orange-200 overflow-hidden">
                                        <HeroIcon icon={t.icon} name={t.name} className="w-full h-full flex items-center justify-center text-lg" />
                                    </div>
                                    <div className="flex-1">
                                        <div className="font-bold text-base lg:text-lg text-slate-200">{t.name}</div>
                                        <span className={cn(
                                ...
                                <div className="grid grid-cols-4 gap-2 mb-6 border-t border-white/5 pt-4">
                                    <div className="flex flex-col items-center p-1.5 lg:p-2 bg-white/5 rounded">
