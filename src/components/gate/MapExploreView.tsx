        ...
        <div className="max-w-3xl mx-auto h-full flex flex-col animate-in fade-in duration-500 relative">
            ...
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                    <h3 className="font-serif text-2xl text-slate-200 tracking-widest">第 {ruinsRun.currentFloor} 阵</h3>
                ...
                <div className="flex items-center gap-4 text-[10px] font-mono text-slate-500 uppercase tracking-wider">
                    ...
                    <span className="flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-violet-500/50"></span>宝箱</span>
                    <span className="flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-red-500/50"></span>BOSS</span>
                </div>
            </div>
            ...
            <div className="flex-1 flex flex-col items-center justify-center gap-10 py-6 relative">
                ...
                <div className="flex flex-col items-center gap-0">
                    ...
                    <div className="w-px h-8 bg-gradient-to-b from-transparent to-white/10"></div>
                </div>
                ...
                {hoveredNode && !hoveredNode.completed && (
                    <div className="absolute top-4 right-0 w-56 bg-black/90 backdrop-blur-md border border-white/10 rounded-xl p-4 shadow-2xl animate-in fade-in zoom-in-95 duration-200 z-20">
                        {(() => {
            ...
            {/* Party Status Bar */}
            <div className="mt-auto pt-4 border-t border-white/5 bg-black/30 rounded-xl p-4 backdrop-blur-sm">
