...
export default function MissionSelectionView({ onSelect }: { onSelect: (id: string) => void }) {
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 pb-8 lg:pb-0">
            {Object.entries(MISSIONS).map(([id, m]) => (
                ...
                >
                    ...
                    <div className="relative z-10 flex flex-col h-full">
                        ...
                        <h3 className="text-base lg:text-xl font-bold text-slate-200 mb-2 font-serif group-hover:text-orange-300 transition-colors">{m.name}</h3>
